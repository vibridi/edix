...
public class SpecConverter {
	...
	// READ FROM
	private static final String tset = "837P";	// CHANGE ME
	private static final String version = "5010";	// CHANGE ME
	private static final String source = "xml-descriptors/Ansi-%s-%sSpecification.xml";
	
	
	// WRITE TO
	private static final String dstVersion = "501"; 									// CHANGE ME if needed
	private static final String desc = "Health Care Claim - Professional"; 				// CHANGE ME
